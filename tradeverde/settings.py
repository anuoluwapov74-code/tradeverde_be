"""
Django settings for tradeverde project.
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='VerdeTrades <support@verdetrades.com>')
ADMIN_NOTIFICATION_EMAIL = config('ADMIN_NOTIFICATION_EMAIL', default='support@verdetrades.com')
...
MIDDLEWARE = [
    ...
    'tradeverde.middleware.AppendSlashMiddleware',
...
WSGI_APPLICATION = 'tradeverde.wsgi.application'
