...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='VerdeTrades <support@verdestrades.com>')
ADMIN_NOTIFICATION_EMAIL = config('ADMIN_NOTIFICATION_EMAIL', default='support@verdestrades.com')
